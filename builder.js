...
export default function GroupsTab({
  groups, setGroups, isLoadingGroups, students, teacherId, newStudent, setNewStudent, setIsAddStudentModalOpen, setSelectedStudent, handleWhatsAppReport, handleGenerateMonthlyReport, handleDeleteStudent, setEditStudentForm, setIsEditStudentModalOpen, setStatsData, setIsStatsModalOpen, formatTime12h
}: GroupsTabProps) {
...
fs.writeFileSync('src/components/groups/GroupsTab.tsx', head + handleAddGroup + middle + handleDelete + groupsUI + groupModal + privateModal + tail);
console.log('Done!');
